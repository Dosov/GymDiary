...
//
//public class GymResultExercise extends AppCompatActivity  {
...
//        getAllResulitExrecise(cursor);
//        Adapter adapter=new ArrayAdapter<String>(this,R.layout.results,ResultExrecise);
////        listView.setAdapter((ListAdapter) adapter);
//        // добавляем контекстное меню к списку
//        registerForContextMenu(listView);
//        revert3.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intent =new Intent(GymResultExercise.this,MainActivity.class);
...
//        });
//    }
//    public void getAllResulitExrecise(Cursor cursor){
//        int a=0;
//        if (cursor!=null){
//            if(cursor.moveToFirst()){
//                int idIndex = cursor.getColumnIndex(DB.COLUMN_ID);
//                int nameColIndex = cursor.getColumnIndex(DB.COLUMN_DATA);
//                int nameExerciseColIndex = cursor.getColumnIndex(DB.COLUMN_NAME);
//                   int emailColIndex = cursor.getColumnIndex(DB.COLUMN_CHRONOMETER);
//                do {
